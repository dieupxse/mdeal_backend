...
public class RenewService extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            String enable_mt_block = vn.ctnet.confi.Ultility.getValue("enable_mt_block");
                    ...
                    for (Service sv : lsv) {
                        ...
                        if (pkg != null) {
                            ...
                            if (rsdb.equals("CPS-0000")) {
                                ...
                                if(enable_mt_renew!=null && enable_mt_renew.equals("1") && sv.getPackageID().equals("D90")) {
                                    //gia han thanh cong
                            ...
                            else if(rsdb.equals("CPS-1004") || rsdb.equals("CPS-1007") || rsdb.startsWith("CPE")) 
                            {
                                ...
                                if(enable_mt_block!=null && enable_mt_block.equals("1")) {
