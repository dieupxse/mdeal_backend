 ...
 * @author dieup
 */
public class SubmitMessage extends Thread {
   SMPPSession session;
    String message;
    String msisdn;
    String brandName;
     ...
     * @param brandName
     */
    SubmitMessage(SMPPSession session, String message, String msisdn, String brandName) {
    ...
    public String submitMessage(SMPPSession session, String message, String msisdn, String brandName) {
        ...
        for (int i = 0; i < totalSegments; i++) {
            ...
            messageId = mdeal.vn.process.Process.submitMessage(session, mes,
